...
/**
 *  ласс дл€ работы с постами в NanoGrabbr
 * 
...
/**
 * ѕолучение списка постов
 *
 * @param int $page - номер страницы (посты в списке разюиваютс€ на страницы)
...
/**
 * ѕолучение одного конкретного поста
 *
...
/**
 * —охранение нового поста и поста, после редактировани€
 *
...
/**
 * ѕагинатор (разбиение списка постов на страницы)
 *
 ...
 */
	function paginator($pageCount = 1, $pageNum = null) {
		$pageNum++;
		// Ќомер блока со страницами (0 = 1-8, 1 = 9-16, 2 = 16-...)
		$pagesBlockNum = intval(($pageNum-1) / $this->pagesPerLine);
		// ѕерва€ страница в блоке
		$pageStart = $pagesBlockNum * $this->pagesPerLine + 1;
		// ѕоследн€€ страница в блоке (не больше чем колличество страниц)
